...
static  void (*g_callBackPtr1)(void) = NULL_PTR; /* to store the address of the function */
static  void (*g_callBackPtr2)(void) = NULL_PTR; /* to store the address of the function */
